...
public class ShopBillActivity extends MaterialStyleActivity {
    ...
    private TextView tvBillCofirm;//确认门店账单
    ...
    protected void initViews() {
        ...
        tvBillCofirm = (TextView) findViewById(R.id.tv_bill_confirm);
    }
    ...
    protected void initEvent() {
        ...
        tvBillCofirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (result != null) {
                    if (result.getFlag().endsWith("0")) {
                        ...
                        if (shopBill != null) {
                            ...
                            //判断确认账单按钮是否可用
                            if (shopBill.getShopUnConfirmed() > 0){
                                tvBillCofirm.setVisibility(View.VISIBLE);
                            } else {
                                tvBillCofirm.setVisibility(View.GONE);
                            }
                            //判断显示应收还是应付金额
