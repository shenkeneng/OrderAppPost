 ...
 */
public class NoReloadFragmentTabHost extends TabHost implements
	...
	public NoReloadFragmentTabHost(Context context) {
	...
	public NoReloadFragmentTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
